...
export const assignClassScheduleToClassAndCreateAttendance = async (req, res) => {
    const { classScheduleId, classId } = req.params;
  
    try {
      await ClassScheduleService.assignClassScheduleToClassAndCreateAttendance(classScheduleId, classId);
